...
ytb_vos = json.load(open('G:/dataset/object_tracker/sonar/instances_train.json', 'r'))
snippets = dict()
...
json.dump(train, open('G:/dataset/object_tracker/sonar/train.json', 'w'), indent=4, sort_keys=True)
print('done!')
