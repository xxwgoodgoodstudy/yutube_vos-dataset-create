...
def crop_video(video, v, crop_path, data_path, instanc_size):
    ...
    for trackid, o in enumerate(list(v)):
        ...
        for frame in obj:
            ...
            mask = crop_like_SiamFCx((label==int(o)).astype(float), bbox, instanc_size=instanc_size, padding=0)
...
def main(instanc_size=511, num_threads=12):
    dataDir = 'G:/dataset/object_tracker/sonar'
    crop_path = 'G:/dataset/object_tracker/sonar/crop{:d}'.format(instanc_size)
